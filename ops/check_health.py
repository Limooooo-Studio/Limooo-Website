...
from config import DATA_DIR, ENV_FILE  # noqa: E402

from d1_client import cloudflare_config, d1_query, env_value, load_env  # noqa: E402
...
def _schema_statements() -> list[str]:
    """与 ops/migrations/003_events.sql / 005_retention.sql 保持一致的幂等 DDL。"""
    return [
        """
