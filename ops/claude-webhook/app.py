...
<nav class="site-nav fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl z-[100] flex items-center px-5 md:px-8 h-[70px] md:h-[100px] claude-nav" aria-label="主导航">
  <a href="https://limooo.cn" class="flex items-center gap-2 md:gap-2.5 shrink-0"><span class="nav-brand text-lg md:text-2xl font-semibold tracking-[0.05em]">Limooo</span></a>
